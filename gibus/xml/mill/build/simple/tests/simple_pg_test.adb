--
-- Created by ada_generator.py on 2010-02-14 12:16:48.355078
-- 
...
--
   procedure Standard_User_Create_Test(  T : in out AUnit.Test_Cases.Test_Case'Class ) is
      ...
      begin
         ...
         Logger.info( To_String( Standard_User_Test_Item ));
      end print;
   ...
   begin
      startTime := Clock;
      Logger.info( "Starting test Standard_User_Create_Test" );
      
      Logger.info( "Clearing out the table" );
      Standard_User_io.Delete( criteria );
      
      Logger.info( "Standard_User_Create_Test: create tests" );
      ...
      Logger.info( "Standard_User_Create_Test: alter tests" );
      ...
      Logger.info( "Standard_User_Create_Test: delete tests" );
      for i in RECORDS_TO_DELETE .. RECORDS_TO_ADD loop
         Standard_User_Test_Item := Standard_User_List.element( Standard_User_test_list, i );
         Standard_User_io.Delete( Standard_User_Test_Item );         
      end loop;
      
      Logger.info( "Standard_User_Create_Test: retrieve all records" );
      Standard_User_List.iterate( Standard_User_test_list, print'Access );
      endTime := Clock;
      elapsed := endTime - startTime;
      Logger.info( "Ending test Standard_User_Create_Test. Time taken = " & elapsed'Img );

   exception 
      when Error : others =>
         Logger.error( "Standard_User_Create_Test execute query failed with message " & Exception_Information(Error) );
         assert( False,  
...
--
   procedure Standard_Group_Create_Test(  T : in out AUnit.Test_Cases.Test_Case'Class ) is
      ...
      begin
         ...
         Logger.info( To_String( Standard_Group_Test_Item ));
      end print;
   ...
   begin
      startTime := Clock;
      Logger.info( "Starting test Standard_Group_Create_Test" );
      
      Logger.info( "Clearing out the table" );
      Standard_Group_io.Delete( criteria );
      
      Logger.info( "Standard_Group_Create_Test: create tests" );
      for i in 1 .. RECORDS_TO_ADD loop
      ...
      Logger.info( "Standard_Group_Create_Test: alter tests" );
      for i in 1 .. RECORDS_TO_ALTER loop
      ...
      Logger.info( "Standard_Group_Create_Test: delete tests" );
      for i in RECORDS_TO_DELETE .. RECORDS_TO_ADD loop
         Standard_Group_Test_Item := Standard_Group_List.element( Standard_Group_test_list, i );
         Standard_Group_io.Delete( Standard_Group_Test_Item );         
      end loop;
      
      Logger.info( "Standard_Group_Create_Test: retrieve all records" );
      Standard_Group_List.iterate( Standard_Group_test_list, print'Access );
      endTime := Clock;
      elapsed := endTime - startTime;
      Logger.info( "Ending test Standard_Group_Create_Test. Time taken = " & elapsed'Img );

   exception 
      when Error : others =>
         Logger.error( "Standard_Group_Create_Test execute query failed with message " & Exception_Information(Error) );
         assert( False,  
...
--
   procedure Group_Members_Create_Test(  T : in out AUnit.Test_Cases.Test_Case'Class ) is
      ...
      begin
         ...
         Logger.info( To_String( Group_Members_Test_Item ));
      end print;
   ...
   begin
      startTime := Clock;
      Logger.info( "Starting test Group_Members_Create_Test" );
      
      Logger.info( "Clearing out the table" );
      Group_Members_io.Delete( criteria );
      
      Logger.info( "Group_Members_Create_Test: create tests" );
      for i in 1 .. RECORDS_TO_ADD loop
      ...
      Logger.info( "Group_Members_Create_Test: alter tests" );
      for i in 1 .. RECORDS_TO_ALTER loop
      ...
      Logger.info( "Group_Members_Create_Test: delete tests" );
      for i in RECORDS_TO_DELETE .. RECORDS_TO_ADD loop
         Group_Members_Test_Item := Group_Members_List.element( Group_Members_test_list, i );
         Group_Members_io.Delete( Group_Members_Test_Item );         
      end loop;
      
      Logger.info( "Group_Members_Create_Test: retrieve all records" );
      Group_Members_List.iterate( Group_Members_test_list, print'Access );
      endTime := Clock;
      elapsed := endTime - startTime;
      Logger.info( "Ending test Group_Members_Create_Test. Time taken = " & elapsed'Img );

   exception 
      when Error : others =>
         Logger.error( "Group_Members_Create_Test execute query failed with message " & Exception_Information(Error) );
         assert( False,  
